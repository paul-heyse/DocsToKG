...
This reference describes the ``EuropePmcResolver`` class provided by the consolidated module ``DocsToKG.ContentDownload.pipeline.providers``.
...
Usage:
    from DocsToKG.ContentDownload.pipeline.providers import EuropePmcResolver
