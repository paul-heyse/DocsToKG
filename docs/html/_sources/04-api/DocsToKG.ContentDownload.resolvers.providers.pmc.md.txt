...
This reference describes the ``PmcResolver`` class provided by the consolidated module ``DocsToKG.ContentDownload.pipeline.providers``.
...
Usage:
    from DocsToKG.ContentDownload.pipeline.providers import PmcResolver
