...
- **WHEN** existing code imports `from DocsToKG.ContentDownload.resolvers import ResolverPipeline`
...
- **WHEN** new code imports `from DocsToKG.ContentDownload.resolvers.pipeline import ResolverPipeline`
...
- **WHEN** tests import a single resolver: `from DocsToKG.ContentDownload.resolvers.providers.unpaywall import UnpaywallResolver`
