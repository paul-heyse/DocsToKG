...
from .foundation import mask_sensitive_data, sanitize_filename

if TYPE_CHECKING:  # pragma: no cover - type checking only
    from .pipeline import FetchSpec  # pylint: disable=cyclic-import
...
def _make_fetch_spec(
    ...
    from .pipeline import FetchSpec as _FetchSpec  # Local import avoids circular dependency
...
def setup_logging(
    *,
    ...
    from .infrastructure import LOG_DIR  # Local import to avoid circular dependency
