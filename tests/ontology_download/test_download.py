...
from DocsToKG.OntologyDownload.core import ConfigurationError, FetchSpec, _ensure_license_allowed
...
def test_ensure_license_allowed_normalizes_spdx() -> None:
    config = ResolvedConfig(
        defaults=DefaultsConfiguration(accept_licenses=["CC-BY-4.0"]),
        specs=[],
    )
